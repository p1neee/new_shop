...
//	include 'scripts.php';
	...
	$param_keys=array('name', 'descr'); // названия полей в таблице БД
	$param_str=array('Наименование', 'Описание'); // названия столбцов в таблице для отображения
	...
	$textarea=array('descr'); // поля типа "textarea"
